...
{
        if (Application->MessageBox("Czy na pewno utworzyc nowy plik?","Tworzenie nowego pliku", MB_YESNOCANCEL |MB_ICONQUESTION) == IDYES)
        {
         tresc->Lines->Clear();
         nazwapliku="";
        }
...
{
          if (Application->MessageBox("Czy na pewno zakoñczyæ program?","Zakañczanie programu", MB_YESNO |MB_ICONQUESTION) == IDYES)
        {
...
{
       if (Application->MessageBox("Czy na pewno zakoñczyæ program?","Zakañczanie programu", MB_YESNO |MB_ICONQUESTION) == IDNO)
        {
         Action=caNone;
        }
}
...
void __fastcall TForm1::Wklei1Click(TObject *Sender)
{
...
void __fastcall TForm1::Facebookautora1Click(TObject *Sender)
{
    ShellExecute(NULL, "open", "https://www.facebook.com/kkasztann", NULL, NULL, SW_SHOWNORMAL);
}
//---------------------------------------------------------------------------
